import{_ as s,r as e,o as t,c,a as n,b as p,e as l,d as i}from"./app-2d6feb9f.js";const o={},r=i(`<h1 id="链表倒序遍历" tabindex="-1"><a class="header-anchor" href="#链表倒序遍历" aria-hidden="true">#</a> 链表倒序遍历</h1><p>我们的任务是倒序遍历给定的链表</p><p>比如下面的链表</p><figure><img src="https://upload.wikimedia.org/wikipedia/commons/6/6d/Singly-linked-list.svg" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>遍历的顺序应该是</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>37 → 99 → 12
