import{_ as p,r as e,o,c,a as n,b as a,e as t,d as l}from"./app-2d6feb9f.js";const i="/assets/graph-03e0a08e.jpeg",u={},k=l('<h1 id="图" tabindex="-1"><a class="header-anchor" href="#图" aria-hidden="true">#</a> 图</h1><p>在计算机科学中, <strong>图(graph)</strong> 是一种抽象数据类型, 旨在实现数学中的无向图和有向图概念，特别是图论领域。</p><p>一个图数据结构是一个(由有限个或者可变数量的)顶点/节点/点和边构成的有限集。</p><p>如果顶点对之间是无序的,称为无序图,否则称为有序图;</p><p>如果顶点对之间的边是没有方向的,称为无向图,否则称为有向图;</p><p>如果顶点对之间的边是有权重的,该图可称为加权图。</p><figure><img src="'+i+`" alt="Graph" tabindex="0" loading="lazy"><figcaption>Graph</figcaption></figure><h2 id="完整代码" tabindex="-1"><a class="header-anchor" href="#完整代码" aria-hidden="true">#</a> 完整代码</h2><h3 id="graph" tabindex="-1"><a class="header-anchor" href="#graph" aria-hidden="true">#</a> Graph</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>
